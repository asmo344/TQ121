...
{
    public sealed partial class T7806 : IRegisterScan
    {
            ...
            for (var idx = 0; idx < length; idx++)
            {
                ...
                if (type == RegisterReadWriteType.RO)
                {
                    ...
                    for (i = 1; i <= 5; i++)
                    {
                        ...
                        WriteSPIRegister(addr, (ushort)randomVal);
                        switch (i)
                        {
                            case 1:
                        ...
                        if (page == 0x06)
                        {
                            switch (addr)
                            {
                                ...
                                case 0x41:
                                    ...
                                    WriteSPIRegister(addrtmp, (ushort)randomValtmp);
                                    Task.Delay(10);
                                    exception = true;
                                    break;
                                default:
